...
## Have a try!
* Download the environment [py39.7z](https://drive.google.com/file/d/1POBWriSqLJI8Vf6sPYCKQ2IxHoMAFW5Z/view?usp=sharing) from Google Drive, Copy the extracted **py39** folder into the directory of your conda environment.
* Download the code repository and extract it to your local disk.
* Download the dataset [TU_HETERO_CAR_WITH_PLATE_MINI.7z](https://drive.google.com/file/d/1IU5QursM8IF3URS2z6RchYytgJ_uZYCQ/view?usp=sharing) from Google Drive, Copy the extracted **TU_HETERO_CAR_WITH_PLATE_MINI** folder into the **StructureGraph/datasets** folder of the code.
